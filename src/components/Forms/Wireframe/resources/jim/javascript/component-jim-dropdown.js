...
(function (window, undefined) {
  ...
  /*********************** START DROPDOWN METHODS ************************/
	...
	function createDropDown(element) {
		var html = '<div class="jim-web-dd ' + jQuery(element).attr("id") + '" onselectstart="return false;"><div class="dd_content" class="scrollable"><div class="dd_options"></div></div></div>';
